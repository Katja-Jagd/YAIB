...
# Execute command
icu-benchmarks train     -d /work3/s185395/YAIB-cohorts/data/mortality24/miiv   -n miiv     -t BinaryClassification     -tn Mortality24     -m BAT     -gc     -lc -s 2222     -l ../yaib_logs/ --wandb-sweep
