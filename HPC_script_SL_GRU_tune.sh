...
# Execute command
icu-benchmarks train     -d /work3/s185395/YAIB-cohorts/data/mortality24/mimic   -n mimic     -t BinaryClassification     -tn Mortality24     -m GRU     -gc     -lc -s 2222     -l ../yaib_logs/ --wandb-sweep --tune
