...
#BSUB -o /work3/s185395/YAIB/hpc_output/test_output_gpuv100.out
#BSUB -e /work3/s185395/YAIB/hpc_output/test_output_gpuv100.err

# Activate venv  and load modules 
module load python3/3.10.16
source yaib_venv/bin/activate

python3 python_gpu_check.py

# === Diagnostic info ===
echo "Job started on: $(hostname)"
echo "Running in queue: $LSB_QUEUE"
echo "Job ID: $LSB_JOBID"
echo "Allocated host(s): $LSB_HOSTS"
